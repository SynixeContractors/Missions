    ...
    [
        ...
        ],
        {
            ...
            if ((_values#0 isEqualTo (_args#0 getVariable ["mission_password", "99999999"]))) then {
                ...
                _args#0 setObjectTextureGlobal [0, "a3\structures_f\items\electronics\data\electronics_screens_laptop_co.paa"];
            };
        },
        {},
        [_target]
...
[river_laptop, 2, false, 1, "Inspect laptop", [], 30, "Information from laptop", loadFile "intel\river_camp.txt"] call zen_modules_fnc_addIntelAction;
[intel_radio, 2, true, 1, "Listen in on radio", [], 15, "Radio transmission from poacher base", loadFile "intel\radio_transmission.txt"] call zen_modules_fnc_addIntelAction;