...
private _action = [
    ...
    "",
    {
        ...
        [2, [tablelaptop, player], _onFinish, nil, "Disabling communications...", nil] call ace_common_fnc_progressBar;
    },
    {
...
private _hackHardDriveAction = [
    ...
    "",
    {
        ...
        // Call the progress bar function with no condition for canceling the action
        [30, [tablelaptop, player], _onFinishHacking, nil, "Hacking Hard Drive...", nil] call ace_common_fnc_progressBar;
    },
    {
