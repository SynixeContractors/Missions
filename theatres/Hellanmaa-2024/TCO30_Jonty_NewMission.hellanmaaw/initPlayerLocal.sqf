...
[apcintel, 2, false, 1, "Get Intel", [], 2, "Stolen APCs Report", "Confirmed two APCs aquired during the last ambush on the UNA convoy. Vehicles will be covertly transported to the Ranch hideout at midnight for proximity to the Polk Baskera outpost. Reinforcements en route from HQ, E, NE towers due to UNA alertness. Expect significant resistance due to the high-value nature of the vehicles. Deployment is scheduled for 24 hours hence."] call zen_modules_fnc_addIntelAction;
