...
[autorifleman_control, 0, ["ACE_MainActions"], _clearAll] call ace_interact_menu_fnc_addActionToObject;
...
[autorifleman_control, 0, ["ACE_MainActions"], _step1] call ace_interact_menu_fnc_addActionToObject;
