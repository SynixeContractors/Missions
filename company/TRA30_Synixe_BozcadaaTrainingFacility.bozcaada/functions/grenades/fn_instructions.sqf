...
0 spawn {
    ...
    sleep 1.5;
    ["Grenades - Target 1", true] call FUNC(layerToggle);
    sleep 0.5;
    ["Grenades - Target 1", false] call FUNC(layerToggle);
    sleep 0.5;
    ["Grenades - Target 1", true] call FUNC(layerToggle);
    sleep 0.5;
    ["Grenades - Target 1", false] call FUNC(layerToggle);
    ...
    ["Grenades - Target 1", false] call FUNC(layerToggle);
    sleep 7.5;
    ["Grenades - Target 2", true] call FUNC(layerToggle);
    sleep 0.5;
    ["Grenades - Target 2", false] call FUNC(layerToggle);
    sleep 0.5;
    ["Grenades - Target 2", true] call FUNC(layerToggle);
    sleep 0.5;
    ["Grenades - Target 2", false] call FUNC(layerToggle);
