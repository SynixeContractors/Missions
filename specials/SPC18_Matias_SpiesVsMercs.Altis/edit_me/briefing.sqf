...
_player createDiaryRecord ["Diary", ["Game Rules", "
        ...
        <br/>3- Game ends either when the laptops are hacked and at least one spy escapes or when all the spies are killed.
...
switch (side _player) do {
    ...
    case west: {
        _player createDiaryRecord ["Diary", ["Briefing", "
            ...
            <br/>Once you've breached all three of the laptops you must exfil back to the safehouse
            <br/>
            <br/>Good Luck, Zero.
        "]];
